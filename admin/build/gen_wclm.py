...
<p class="wc-parked"><b>Parked, not abandoned (brief 39).</b> This experiment is paused while the estate turns to the review process for its two books. The founder's reason is worth quoting: it was &ldquo;a good example of a solution&hellip; that needed a better target, a better environment&rdquo;, and the review era is meant to be that environment. Everything here still runs, and every gate still guards it.</p>
