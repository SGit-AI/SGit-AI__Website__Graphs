...
NAV = [
    ...
    ("The books", "v2/books/index.html", [
        ("The shelf &middot; all three, each with its own version", "v2/books/index.html"),
        ("Fractal Semantic Graphs &middot; the argument whole", "v2/books/fsg/index.html"),
        ("&hellip; about this book", "v2/books/fsg/about.html"),
        ("&hellip; read it as one PDF", "v2/books/fsg/fsg.pdf"),
        ("Creating a Book &middot; the making-of", "v2/books/making-a-book/index.html"),
        ("&hellip; about this book", "v2/books/making-a-book/about.html"),
    ...
    ("The universe", "v2/universe/index.html", [
        ...
        ("The artefact catalogue", "v2/artefacts/index.html"),
        ...
        ("&hellip; its operators, each in its folder", "v2/wclm/operators/index.html"),
