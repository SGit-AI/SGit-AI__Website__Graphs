    ...
    {"id": "WS-04", "title": "The version diff", "color": "#9333ea", "status": "next",
     ...
     "tasks": [
         ...
         {"id": "WS-04b", "title": "Text diff between two book versions from the tags",
          ...
          "note": "v0.6.17; per BOOK version, from the markdown, reusing the v1 differ"},
         ...
         {"id": "WS-04e", "title": "A review register, so a reading survives its consequence",
          "status": "done", "owner": "@librarian",
          "note": "v0.6.17; the brief 40 reading recorded as r001, two items still open"},
     ]},
