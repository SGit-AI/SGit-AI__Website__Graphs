...
| Term | Say this instead | What it is |
|---|---|---|
| Node | a thing | Anything you want to say something about. On its own it means nothing; [that is the first idea in this book](../start/index.html#node). |
...
| Fractal | same rules at every zoom level | A precise claim, not a decoration: self-similarity, scale invariance, composition, recursion, and **no new format and no special case** when you zoom in. [How to falsify it](../depth/boundaries.html#fractal). |
...
## Words this book does not use {#not}
...
| “graph database” | There isn't one. [Said plainly in its own chapter.](../shipped/index.html) |
