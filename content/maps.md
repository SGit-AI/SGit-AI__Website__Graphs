...
| Set | State |
|---|---|
| **The strategy maps**: eight rendered images, the only rendered graph visuals in the corpus | <span class="pill p-ships">rendered</span> Some exist as inline SVG on the parent project: [sgit.ai/demos/strategy-maps.md](https://sgit.ai/demos/strategy-maps.md) |
...
| **The air-gap map**: the sharpest single map here | <span class="pill p-argued">unrendered</span> Task T4 on [the comms board](../admin/comms.html), the project's public task list |
